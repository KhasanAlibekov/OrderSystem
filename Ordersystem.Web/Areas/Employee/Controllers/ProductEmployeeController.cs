...
namespace Ordersystem.Web.Areas.Employee.Controllers
{
    [Area("Employee")]
    [Authorize(Roles = ApplicationRoles.Role_Employee)]
    public class ProductEmployeeController : Controller
    {
        IProductService _serviceProduct;
        ICategoryService _serviceCategory;
        ISupplierService _serviceSupplier;
        private readonly IWebHostEnvironment _webHostEnvironment;
        public ProductEmployeeController(IProductService serviceProduct, ICategoryService serviceCategory, ISupplierService serviceSupplier, IWebHostEnvironment webHostEnvironment)
        {
